...
//! the getTelephone function returns an initializer list that can be
//! used in the Telephone constructor. The {} initialization automatically
//! maps {"Soheil Enia", 12345} to the Telephone type. The getTelephone()method is used in line 73 to construct a Telephone object.

Telephone getTelephone()
{
    return {"Soheil Enia", 12345};
}
...
int main()
{
    ...
    //getTelephone returns an initializaer list
